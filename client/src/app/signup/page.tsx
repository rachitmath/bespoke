...
import { Sparkles, ArrowRight, Loader2, AlertCircle, Lock, Mail, CheckCircle2 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-slate-50 dark:bg-slate-950">
        ...
        <div className="w-full max-w-md space-y-6">
          <div className="text-center space-y-2">
            ...
            <h1 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">
              Create your Bespoke account
            </h1>
            <p className="text-sm text-slate-500 dark:text-slate-400">
              Get 3 free AI-tailored resumes and LinkedIn outreach notes every month
            </p>
          </div>
      ...
      <footer className="py-6 text-center text-xs text-slate-400 border-t border-slate-200 dark:border-slate-800">
        Bespoke SaaS • PostgreSQL & Prisma Persistence
      </footer>
    </div>
  );
}
